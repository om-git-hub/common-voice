...
contribution-misreadings-example-2-title = Daaynoosaroota gurguddoo bara Tiriyaassik.
contribution-misreadings-example-2-explanation = [“daaynoosaroota” ta’uu qabu]
contribution-misreadings-example-3-title = Daaynoosaroota gurguddoo kan Tiriyaassik-.
contribution-misreadings-example-3-explanation = [Jecha dhumaa dursee waraabbiin adda citeera]
contribution-misreadings-example-4-title = Daaynoosaroota gurguddoo kan Tiriyaassik. Eeyyee.
contribution-misreadings-example-4-explanation = [Kan barruun barbaaduu ol waraabbameera]
contribution-misreadings-example-5-title = Buna dhuguuf bahaa jirra.
contribution-misreadings-example-6-title = Buna dhuguuf bahaa jirra.
contribution-misreadings-example-6-explanation = [“Nuhi” ta'uu qaba]
contribution-misreadings-example-7-title = Buna dhuguuf bahaa jirra.
contribution-misreadings-example-7-explanation = [Barruu innikkaa keessa ‘a’n hin jiru]
contribution-misreadings-example-8-title = Bambilbiin saffisaan deeme.
